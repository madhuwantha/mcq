...
export const ACTION_TYPES = {
  ...
  PARTIAL_UPDATE_ANSWER: 'answer/PARTIAL_UPDATE_ANSWER',
...
export default (state: AnswerState = initialState, action): AnswerState => {
  switch (action.type) {
    ...
    case REQUEST(ACTION_TYPES.PARTIAL_UPDATE_ANSWER):
      return {
        ...state,
        errorMessage: null,
        updateSuccess: false,
    ...
    case FAILURE(ACTION_TYPES.PARTIAL_UPDATE_ANSWER):
    ...
    case SUCCESS(ACTION_TYPES.PARTIAL_UPDATE_ANSWER):
      return {
        ...state,
        updating: false,
        updateSuccess: true,
...
export const partialUpdate: ICrudPutAction<IAnswer> = entity => async dispatch => {
  const result = await dispatch({
    type: ACTION_TYPES.PARTIAL_UPDATE_ANSWER,
