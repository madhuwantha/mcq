...
/**
 * REST controller for managing {@link com.equitem.soft.mcq.domain.Question}.
 */
@RestController
@RequestMapping("/api")
        ...
        Optional<Question> result = questionRepository
            ...
            .map(
                existingQuestion -> {
                    ...
                    if (question.getQuestionImageLink() != null) {
                        existingQuestion.setQuestionImageLink(question.getQuestionImageLink());
                    }
                    if (question.getAnswerImageLiks() != null) {
                        existingQuestion.setAnswerImageLiks(question.getAnswerImageLiks());
                    }
                    if (question.getCorrectOne() != null) {
                        existingQuestion.setCorrectOne(question.getCorrectOne());
                    }
