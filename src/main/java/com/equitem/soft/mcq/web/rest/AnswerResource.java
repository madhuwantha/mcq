...
/**
 * REST controller for managing {@link com.equitem.soft.mcq.domain.Answer}.
 */
@RestController
@RequestMapping("/api")
public class AnswerResource {
    ...
    public ResponseEntity<Answer> updateAnswer(@PathVariable(value = "id", required = false) final String id, @RequestBody Answer answer)
        ...
        return ResponseEntity
            .ok()
            .headers(HeaderUtil.createEntityUpdateAlert(applicationName, true, ENTITY_NAME, answer.getId()))
            .body(result);
    }
    ...
    public ResponseEntity<Answer> partialUpdateAnswer(
        ...
        return ResponseUtil.wrapOrNotFound(result, HeaderUtil.createEntityUpdateAlert(applicationName, true, ENTITY_NAME, answer.getId()));
    }
